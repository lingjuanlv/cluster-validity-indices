function [center, U, obj_fcn] = fcm(init_U, data, cluster_n, options)
...
obj_fcn = zeros(max_iter, 1);	% Array for objective function
 ...
 U = initfcm(cluster_n, data_n);			% Initial fuzzy partition fixed
%fixed initilization U

% Main loop
for i = 1:max_iter,
	[U, center, obj_fcn(i)] = stepfcm(data, init_U, cluster_n, expo);
	if display, 
